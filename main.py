...
parser.add_argument('--ka', '-alignment_kmer', type=int, help='length of kmers to use for alignment', default = 5)
parser.add_argument('--kb', '-assembly_kmer', type=int, help='length of kmers to use for assembly', default = 10)
parser.add_argument('--m', '-match_score', type=int, help='alignment score for matching base pairs', default = 1)
parser.add_argument('--mi', '-mismatch_score', type=int, help='alignment score for non-matching base pairs', default = -1)
parser.add_argument('--g', '-gap_score', type=int, help='alignment score for introducing a gap', default = -1)
parser.add_argument('--t', '-score_threshold', type=float, help='minimum normalized score needed to be considered an alignment', default = 0.75)
parser.add_argument('--s', '-save', type=bool, help='if True, save intermediate outputs', default = False)
