...
def get_reads_to_align(query_seq, read_dict, k=5):
    ...
    # TODO: edit to return seperate lists for forward and reverse alignments
...
def get_reads_to_assemble(
    ...
    for read, sequence in read_dict.items():
        ...
        reverse = sequence[::-1]
        reverse_score, alignment_reverse = compare_sequences(
            query, reverse, match_score, gap_score, mismatch_score, threshold
        )
